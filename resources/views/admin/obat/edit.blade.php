            ...
            <form action="{{ route('obat.update', $obat->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_obat" value="{{ old('nama_obat', $obat->nama_obat) }}" placeholder="Contoh: Paracetamol 500mg"
                    ...
                    <div>
                        ...
                        <input type="text" name="kemasan" value="{{ old('kemasan', $obat->kemasan) }}" placeholder="Contoh: Strip @ 10 tablet"
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga', $obat->harga) }}" placeholder="Contoh: 15000"
                    ...
                    <div>
                        ...
                        <input type="number" name="stok" value="{{ old('stok', $obat->stok) }}" placeholder="Contoh: 50"
                            class="w-full px-4 py-2 rounded-lg border-2 focus:border-primary focus:outline-none @error('stok') border-red-500 @enderror" required>
                        @error('stok')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
